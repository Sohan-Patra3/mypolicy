...
<body>
  ...
  if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $sql = "INSERT INTO `memb_mst` (`firstname` , `email` , `address` , `dob` , `gender` , `phoneno` ,`maritalstatus` , `doa` , `date`) VALUES ('$firstname' ,  '$email' , '$address' , '$dob' , '$gender' , '$phoneno' , '$maritalStatus', '$doa' ,  current_timestamp())";
  ...
  <div class="main-container d-flex">
    ...
    <div class="content">
      ...
      <div class="container bodyDiv my-4">
        <form class="needs-validation" novalidate="" action="/mypolicy/member.php" method="post">
          <div class="row g-3">
            <div class="col-sm-6">
            ...
            <div class="col-sm-6">
              ...
              <input type="date" class="form-control" id="doa" name="doa" placeholder="" value="" required="">
  ...
  <script>
    ...
    // Get the input element for Date of Anniversary
    ...
    maritalStatusSelect.addEventListener('change', function() {
      ...
      if (maritalStatusSelect.value === 'married') {
        // Enable the Date of Anniversary input
        doaInput.disabled = false;
      } else if (maritalStatusSelect.value === 'unmarried') {
        // Disable the Date of Anniversary input
        doaInput.disabled = true;
        // Clear the value of the Date of Anniversary input
        doaInput.value = '';
      } else {
        doaInput.disabled = true;
        // Clear the value of the Date of Anniversary input
