...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    if (isset($_POST['snoEdit'])) {
        $snoi = $_POST['snoEdit'];
        $snoi = str_replace('<' , '&lt' , $snoi);
        $snoi = str_replace('>' , '&gt' , $snoi);
        ...
        $sql = "UPDATE `memb_mst` SET `firstname` = '$firstname' ,  `email`='$email' , `address`='$address' , `dob`='$dob' , `gender`='$gender' , `phoneno`='$phoneno' , `maritalstatus`='$maritalStatus' , `doa`='$doa' WHERE `memb_mst`.`sno`=$snoi";
    ...
    <div class="modal fade" id="editModal" tabindex="-1" role="dialog" aria-labelledby="editModalLabel"
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <form action="/mypolicy/list.php?sno=<?php echo $_GET['sno'] ?>" method="POST">
                    <div class="modal-body">
                        <input type="hidden" name="snoEdit" id="snoEdit">
                        <div class="form-group">
                            <label for="firstnameEdit">Full Name</label>
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" class="form-control" id="phonenoEdit" name="phonenoEdit"
                                aria-describedby="emailHelp">
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <input type="date" class="form-control" id="doaEdit" name="doaEdit" placeholder="" value="">
    ...
    <div class="main-container d-flex">
        <div class="sidebar" id="side_nav">
            <div class="header-box px-2 pt-3 pb-4 d-flex justify-content-between">
                ...
                <button class="btn d-md-none d-block close-btn px-1 py-0 text-white"><svg
            ...
            <ul class="header-box px-2 pt-2 pb-4">
                <li class="active"><a href="/mypolicy/index.php?sno=<?php echo $encrypt_1 = urlencode(base64_encode($sno)); ?>"
                        class="text-decoration-none px-2 py-2 d-block"><svg xmlns="http://www.w3.org/2000/svg"
                            width="16" height="16" fill="currentColor" class="bi bi-house-door-fill"
                            viewBox="0 0 16 16">
                            <path
                                d="M6.5 14.5v-3.505c0-.245.25-.495.5-.495h2c.25 0 .5.25.5.5v3.5a.5.5 0 0 0 .5.5h4a.5.5 0 0 0 .5-.5v-7a.5.5 0 0 0-.146-.354L13 5.793V2.5a.5.5 0 0 0-.5-.5h-1a.5.5 0 0 0-.5.5v1.293L8.354 1.146a.5.5 0 0 0-.708 0l-6 6A.5.5 0 0 0 1.5 7.5v7a.5.5 0 0 0 .5.5h4a.5.5 0 0 0 .5-.5" />
                        </svg>Dashboard</a></li>
                <li><a href="/mypolicy/policy.php?sno=<?php echo $encrypt_1 = urlencode(base64_encode($sno)); ?>"
                        class="text-decoration-none px-2 py-2 d-block"><svg xmlns="http://www.w3.org/2000/svg"
                            width="16" height="16" fill="currentColor" class="bi bi-list" viewBox="0 0 16 16">
                            <path fill-rule="evenodd"
                                d="M2.5 12a.5.5 0 0 1 .5-.5h10a.5.5 0 0 1 0 1H3a.5.5 0 0 1-.5-.5m0-4a.5.5 0 0 1 .5-.5h10a.5.5 0 0 1 0 1H3a.5.5 0 0 1-.5-.5m0-4a.5.5 0 0 1 .5-.5h10a.5.5 0 0 1 0 1H3a.5.5 0 0 1-.5-.5" />
                        </svg>Add Policy</a></li>
                <li><a href="/mypolicy/policyDetails.php?sno=<?php echo $encrypt_1 = urlencode(base64_encode($sno)); ?>"
                        class="text-decoration-none px-2 py-2 d-block"><svg xmlns="http://www.w3.org/2000/svg"
                            width="16" height="16" fill="currentColor" class="bi bi-menu-down" viewBox="0 0 16 16">
                            <path
                ...
                <li><a href="/mypolicy/index.php?sno=<?php echo $encrypt_1 = urlencode(base64_encode($sno)); ?>"
                        class="text-decoration-none px-2 py-2 d-block"><svg xmlns="http://www.w3.org/2000/svg"
                            width="16" height="16" fill="currentColor" class="bi bi-shield-fill-plus"
                            viewBox="0 0 16 16">
                            <path fill-rule="evenodd"
            ...
            <ul class="list-unstyled">
                <li><a href="/mypolicy/index.php?sno=<?php echo $encrypt_1 = urlencode(base64_encode($sno)); ?>"
                        class="text-decoration-none px-2 py-2 d-block"><svg xmlns="http://www.w3.org/2000/svg"
                            width="16" height="16" fill="currentColor" class="bi bi-snow3" viewBox="0 0 16 16">
            ...
            <nav class="navbar navbar-expand-lg bg-body-tertiary">
                <div class="container-fluid">
                    <div class="d-flex jusfify-content-between d-md-none d-block">
                        ...
                        <button class="btn px-1 py-0 open-btn"><svg xmlns="http://www.w3.org/2000/svg" width="36"
                                height="36" fill="currentColor" class="bi bi-text-right" viewBox="0 0 16 16">
                                <path fill-rule="evenodd"
                                    d="M6 12.5a.5.5 0 0 1 .5-.5h7a.5.5 0 0 1 0 1h-7a.5.5 0 0 1-.5-.5m-4-3a.5.5 0 0 1 .5-.5h11a.5.5 0 0 1 0 1h-11a.5.5 0 0 1-.5-.5m4-3a.5.5 0 0 1 .5-.5h7a.5.5 0 0 1 0 1h-7a.5.5 0 0 1-.5-.5m-4-3a.5.5 0 0 1 .5-.5h11a.5.5 0 0 1 0 1h-11a.5.5 0 0 1-.5-.5" />
                            </svg></button>
                    </div>
                        ...
                        <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                            <li class="nav-item">
                                <a class="nav-link active" aria-current="page"
                                    href="/mypolicy/index.php?sno=<?php echo $encrypt_1 = urlencode(base64_encode($sno)); ?>">Home</a>
                            </li>
                            <li class="nav-item">
                    ...
                    <div class="table-container">
                        <table>
                            ...
                            <tr id="tr">
                                ...
                                <th data-cell="first name">Full Name</th>
                            ...
                            while ($row = mysqli_fetch_assoc($result)) {
                                ...
                                echo " <tr>
<td scope='row' data-cell='sno'>" . $row['sno'] . "</td>
...
<button class='btn btn btn-danger delete my-1' data-sno='" . $row['sno'] . "'>Delete</button>
</tr>";
                            }
                            ?>
    ...
    Array.from(edits).forEach((element) => {
        element.addEventListener("click", (e) => {
            ...
            maritalStatus = tr.getElementsByTagName("td")[7].innerText;
            doa = tr.getElementsByTagName("td")[8].innerText;
            console.log(firstname,  email, address, dob, gender, phoneno, maritalStatus, doa);
    ...
    // Now you can use the sno to perform your delete operation or pass it to your delete function via AJAX
    if(confirm("Are you sure you want to delete item number " + sno + "?")) {
        // If the user confirms the delete action
        $.ajax({
            url: 'delete.php', // URL of the script to handle the delete operation
            method: 'POST',
            data: {sno: sno}, // Data to be sent to the server, sno is the identifier for the item to be deleted
            success: function(response) {
                // Handle the success response from the server
                console.log("Item number " + sno + " deleted successfully.");
                // You might want to refresh the page or update the UI after successful deletion
            ...
            error: function(xhr, status, error) {
                ...
                alert("An error occurred while deleting item number " + sno + ". Please try again later.");
            }
        });
    }
});
